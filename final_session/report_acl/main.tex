...
% ---- ACL format (acl.sty + acl_natbib.bst from acl-org/acl-style-files) ----
\usepackage{acl}
\usepackage{times}
\usepackage{latexsym}
...
\title{Over-Squashing \textit{vs.}\ Adversarial Robustness in GNNs:\\
An ``Add \textit{vs.}\ Remove Edge'' Investigation}

\author{Supanut Kompayak (st126055) \\
  Asian Institute of Technology \\
  \texttt{st126055@ait.asia} \\\And
  Dechathon Niamsa-Ard (st126235) \\
  Asian Institute of Technology \\
  \texttt{st126235@ait.asia}}
...
\begin{tabular}{@{}lccc@{}}
\toprule
\textbf{Method} ($643$) & \textbf{Clean} & \textbf{Rob@.05} & \textbf{Rob@.10} \\
\midrule
GCN (vanilla)        & $83.50$ & $77.05$ & $71.85$ \\
GCN-Jaccard          & $82.16$ & $\mathbf{78.84}$ & $\mathbf{74.45}$ \\
ProxyDelete (rm.)    & $82.03$ & $76.89$ & $71.28$ \\
